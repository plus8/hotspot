...
#    print (s)
    ...
    #draw.text((0, 10), str(ssid,'utf-8'), font=font, fill=255)
    draw.text((0, 10), ssid, font=font, fill=255)
    draw.text((0, 20), str(CPU,'utf-8') + "%", font=font, fill=255)
    draw.text((80, 20), str(temp,'utf-8') , font=font, fill=255)
    #draw.text((0, 34), str(MemUsage,'utf-8'), font=font, fill=255)
